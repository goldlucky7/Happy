...
## 제주에 없는 기능 (해외판에서 먼저 생긴 것)

여기 적힌 것은 **제주 `index.html`에는 없다.** 동기화할 때 "제주에서 빠졌다"고 착각하지 말 것.

| 기능 | 어디에 | 왜 제주엔 없나 |
|---|---|---|
| 💱 환율 계산기 (`#fxBar` · 2026-08-30) | `hanoi.html` | 국내판은 전부 원화라 쓸 일이 없다 |

만드는 법은 `travel-stampbook` 스킬의 **「해외 지역판을 만들 때」**에 정리돼 있다.
